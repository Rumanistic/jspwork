...
<script src="script.js?<%=System.currentTimeMillis() %>" charset="utf-8"></script>
</head>
<body>
		...
		<table align="center">
			...
			<tr>
				...
				<td>
					...
					<input type="button" value="ID중복확인" onclick="isIdExist(this.form.id.value);">
			...
			<tr>
				<td colspan="3" align="center">
					<input type="button" value="회원가입" onclick="signIn();">&emsp;
